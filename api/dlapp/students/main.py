"""Contains routes for DLAPP students"""
...
router = APIRouter(prefix="/dlapp/students", tags=["dlapp"])
...
# delete permission by user before seen by admins
@router.delete(
